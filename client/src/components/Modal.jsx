  ...
  return (
    <Dialog.Root open={isOpen} defaultOpen={isOpen} onOpenChange={onChange}>
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed border drop-shadow-md border-neutral-700 top-1/2 left-1/2 max-h-full h-[97%] md:h-auto md:max-h-[80vh] w-[95%] md:w-[90vw] md:max-w-[500px] -translate-x-1/2 -translate-y-1/2 rounded-lg bg-neutral-800 px-4 py-6 focus:outline-none overflow-auto">
          <Dialog.Title className="text-xl mb-3">{title}</Dialog.Title>
          <Dialog.Description className="text-[16px] mb-4">
            {description}
          </Dialog.Description>
